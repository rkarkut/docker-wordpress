...
class GR_Widget extends WP_Widget {
	...
	public function update( $new_instance, $old_instance ) {
		...
		if ( !empty($api_key) ) {
		    try {
                $api = new GetResponseIntegration($api_key, get_option($this->GrOptionDbPrefix . 'api_url'),
                    get_option($this->GrOptionDbPrefix . 'api_domain'));
    ...
    {
        foreach (Gr_Integration::$post_fields as $field) {
