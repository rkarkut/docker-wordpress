				...
				<tr>
					<td>
						...
						<div style="margin-top: 20px">
							...
							<br/>
							<code>CSS</code>
							- <?php _e( 'Set this parameter to ON, and the form will be displayed in a GetResponse format; set it to OFF, and the form will be displayed in a standard Wordpress format. Allowed only for old forms.',
									'Gr_Integration' ); ?>
							<br/>
							<code>CENTER</code>
							...
							<br/>
							<code>VARIANT</code>
							- <?php _e( 'Set this parameter to customize form variant, allowed values: A-H. Variants can be set in your GetResponse panel. Allowed only for the new forms.',
									'Gr_Integration' ); ?>
						</div>
